...
**Milestone 1, Milestone 2A: Microsoft Entra Authentication Gate, and Milestone 2B: Area Manager Audit to Corrective Action are accepted and complete. Milestone 2C: People & Access + User Invitations is authorised for implementation as of 11 August 2026.** Preserve the Encore application, Cloud connection, PostgreSQL authorisation foundation, authentication architecture, and existing tests. Milestone 2C may implement only the approved People & Access scope in `docs/PEOPLE_AND_ACCESS.md` and ADR-0014.
